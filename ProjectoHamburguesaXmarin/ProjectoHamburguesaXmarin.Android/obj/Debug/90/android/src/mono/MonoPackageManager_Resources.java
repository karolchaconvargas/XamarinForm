...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ProjectoHamburguesaXmarin.Android.dll" comes first in this list. */
		"ProjectoHamburguesaXmarin.Android.dll",
		"FormsViewGroup.dll",
		"ProjectoHamburguesaXmarin.dll",
